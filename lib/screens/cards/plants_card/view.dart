...
import 'package:Autism/screens/cards/plants_card/widget/view.dart';
...
class PlantsCard extends StatefulWidget {
  ...
  @override
  _PlantsCardState createState() => _PlantsCardState();
}
                  ...
                  child: Container(
                    ...
                    child: GridView.count(
                      ...
                      children: List.generate(
                        context.read<PlantsController>().plantsCardItem.length,
                        (index) => InkWell(
                            onTap: () {
                              context
                                  .read<DictionaryController>()
                                  .updateSelectedItems(context
                                      .read<PlantsController>()
                                      .plantsCardItem[index]);
                              showDialog(
                                context: context,
                                  ...
                                  content: Container(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Image.asset(
                                            'assets/images/${context.read<PlantsController>().plantsCardItem[index].image}'),
                                        Text(context
                                            .read<PlantsController>()
                                            .plantsCardItem[index]
                                            .name),
