import 'dart:ui';
import 'package:Autism/screens/cards/animals_card/widget/view.dart';
...
class AnimalsCard extends StatefulWidget {
  const AnimalsCard({Key? key}) : super(key: key);

  @override
  _AnimalsCardState createState() => _AnimalsCardState();
}
    ...
    return Scaffold(
      body: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                const AppBarItem(nameOfCard: 'Animals',),
                Transform.translate(
                      ...
                      children: List.generate(
                        context
                            ...
                            InkWell(
                                ...
                                child: AnimalsCardItem(
                                  image1: 'uni.png',
                                  image: context
                                      .read<AnimalsController>()
                                      .animalCardItems[index].image,
                                  name: context
                                      .read<AnimalsController>()
                                      .animalCardItems[index].image,
                                )),),
